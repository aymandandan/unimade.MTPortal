...
public class MTPortalDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MTPortalGlobalFeatureConfigurator.Configure();
        MTPortalModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MTPortalDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MTPortalResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MTPortal");

            options.DefaultResourceType = typeof(MTPortalResource);
        ...
        {
            options.MapCodeNamespace("MTPortal", typeof(MTPortalResource));
        });
    }
}
